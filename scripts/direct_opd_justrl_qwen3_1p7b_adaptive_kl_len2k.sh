...
EXPERIMENT_NAME=${EXPERIMENT_NAME:-direct_opd_justrl_qwen3_1p7b_adaptive_kl_len2k}
ACTOR_MODEL_PATH=${ACTOR_MODEL_PATH:-"${MODEL_ROOT}/Qwen/Qwen3-1.7B"}
REWARD_MODEL_PATH=${REWARD_MODEL_PATH:-"${MODEL_ROOT}/hbx/JustRL-DeepSeek-1.5B"}
TEACHER_REF_MODEL_PATH=${TEACHER_REF_MODEL_PATH:-"${MODEL_ROOT}/deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B"}
